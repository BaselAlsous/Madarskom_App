...
class ProfileJob extends StatefulWidget {
  ...
  ProfileJob(this.items);

  @override
  _ProfileJobState createState() => _ProfileJobState();
}
      ...
      child: Scaffold(
        body: Stack(children: [
          ...
          ListView(children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 16.0, right: 16.0, top: 74.0),
